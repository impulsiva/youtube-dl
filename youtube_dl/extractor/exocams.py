...
class ExocamsIE(InfoExtractor):
    _VALID_URL = r'https?://(?:[^/]+\.)?exocams\.com/(?:fullvideo/?\?.*?\bb=)?(?P<id>[^/?&#]+)'
    _TESTS = [{
        'url': 'https://www.exocams.com/siswet19/',
        'info_dict': {
            'id': 'siswet19',
            'ext': 'mp4',
        ...
        'url': 'https://exocams.com/fullvideo/?b=caylin',
        'only_matching': True,
    }, {
        'url': 'https://en.exocams.com/siswet19/',
        'only_matching': True,
    }]
    ...
    def _real_extract(self, url):
        ...
        webpage = self._download_webpage(
            'https://exocams.com/%s/' % video_id, video_id,
